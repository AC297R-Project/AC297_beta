...
def experiment():
	...
	for n in range(n_experiments):
		try:
			...
			hedge = Hedge(stocksdir = '../../../data/all_stocks.csv', spydir = '../../../data/spy.csv',begindate=params['begin_date'], enddate=params['end_date'],fromlist=techs)
			hedge_test = Hedge(stocksdir = '../../../data/all_stocks.csv', spydir = '../../../data/spy.csv',begindate=params['test_begin_date'], enddate=params['test_end_date'],fromlist=techs)
